...
<head>
  <meta charset="utf-8">
  <title>Car/Bike Rental|Car/Bike Details</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>ABOUT CAR/BIKE</span><br>We provide high quality and well serviced cars and bikes. </h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
      ...
      <section id="clients"  class="wow fadeInUp">
        <div class="container">
          <div class="section-header">
            <h2>Car/Bike details</h2>
            <p>Every thing you need to know about our vehicles.</p>
          </div>
          <?php 
