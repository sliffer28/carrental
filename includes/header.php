<header id="header">
  <div class="container">
    ...
    <div id="logo" class="pull-left">
     <h1><a href="index.html" id="body" class="scrollto"><span style="color: red;">Drive</span>Quest</a></h1> 
    ...
    <form class="form-inline "  action="search.php" method="post">
      <div class="input-group input-group-sm">
        ...
        <div class="input-group-append">
          <button class="btn btn-navbar" style="background-color: #be0000;" type="submit">
  ...
  <nav id="nav-menu-container">
    <ul class="nav-menu">
      ...
      <li><a href="car_list.php">Vehicle list</a></li>
